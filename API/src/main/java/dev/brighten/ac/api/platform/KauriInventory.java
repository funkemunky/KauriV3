...
public interface KauriInventory extends Iterable<ItemStack> {
     ...
     */
    public boolean contains(@NotNull ItemType material) throws IllegalArgumentException;
     ...
     */
    @NotNull
    public HashMap<Integer, ? extends ItemStack> all(@NotNull ItemType material) throws IllegalArgumentException;
     ...
     * @throws IllegalArgumentException if material is null
     */
    public int first(@NotNull ItemType material) throws IllegalArgumentException;
     ...
     * @throws IllegalArgumentException if material is null
     */
    public void remove(@NotNull ItemType material) throws IllegalArgumentException;
     ...
     *
     * @return The holder of the inventory; null if it has no holder. Entity ID
     */
    @Nullable
